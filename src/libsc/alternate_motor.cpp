...
inline Pin::Name GetPwmAPin(const uint8_t id) {
  switch (id) {
    ...
    case 0:return LIBSC_MOTOR0_PWMA;

    case 1:return LIBSC_MOTOR1_PWMA;
  }
}
...
inline Pin::Name GetPwmBPin(const uint8_t id) {
  switch (id) {
    ...
    case 0:return LIBSC_MOTOR0_PWMB;

    case 1:return LIBSC_MOTOR1_PWMB;
	}
}
...
inline uint32_t GetDeadtime(const uint8_t id) {
  switch (id) {
    ...
    case 0:return LIBSC_MOTOR0_DEADTIME;

    case 1:return LIBSC_MOTOR1_DEADTIME;
	}
}
