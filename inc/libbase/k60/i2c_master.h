...
class I2cMaster : public I2cMasterInterface {
 public:
  ...
  bool GetBytes(const Byte slave_addr, const uint16_t reg_addr, Byte* buf, const uint8_t size);
  ...
  bool SendBytes(const Byte slave_addr, const uint16_t reg_addr, const Byte* bytes, const uint8_t size);
